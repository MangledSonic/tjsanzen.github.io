...
$message = $_REQUEST['message']; 
	...
	$subject = array(); 
	$subject[1] = "Help (Blender)";
		$subject[2] = "Help (Mine-Imator)";
		$subject[3] = "Help (Other)";
	...
	$emailaddress = "tjsanzen@gmail.com"; /* NOTE: Although your email address is visible here in this code, the person contacting you will never see this email address. Your email address will remain on your server, and it will not be sent from your server to the person contacting you. It will also remain invisible to spam bots. Your email address	is also never stored on any of our servers. You can choose to delete or not delete this note when you publish this page. It will not change the functionality of the contact form. */
